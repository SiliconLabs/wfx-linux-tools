...
if 1:
	...
	print ("<ul>")
	print ("<h3>")
	print ("<li>LAN  %s</li>"  % (bash_res("../info.sh ip eth")))
	print ("<li>WLAN %s</li>"  % (bash_res("../info.sh ip wlan")))
	print ("</h3>")
	print ("</ul>")
	print ("</td>")
	print ("</tr>")
...
if 1:
	...
	print ("<ul>")
	print ("<h3>")
	print ("<li>LAN  %s</li>"  % (bash_res("../info.sh mac eth")))
	print ("<li>WLAN %s</li>"  % (bash_res("../info.sh mac wlan")))
	print ("</h3>")
	print ("</ul>")
	print ("</td>")
	print ("</tr>")
...
if "ap" in mode:
	...
	print ("<ul>")
	print ("<h3>")
	print ("<li>%s</li>"  % (bash_res("../info.sh ap ssid")))
	print ("<li>%s</li>"  % (bash_res("../info.sh ap mgmt")))
	print ("<li>%s</li>"  % (bash_res("../info.sh ap wpa=")))
	print ("<li>%s</li>"  % (bash_res("../info.sh ap channel")))
	print ("</h3>")
	print ("</ul>")
	print ("</td>")
	print ("</tr>")
...
if "station" in mode:
	...
	print ("<ul>")
	print ("<h3>")
	print ("<li>%s</li>"  % (bash_res("../info.sh station country")))
	print ("<li>%s</li>"  % (bash_res("../info.sh station wpa_state")))
	print ("<li>%s</li>"  % (bash_res("../info.sh station ^address")))
	print ("</h3>")
	print ("</ul>")
	print ("<ul>")
	print ("<h2>Visible Access Points</h2>")
	print ("<h3>")
	scan_res = bash_res("../info.sh station scan")
